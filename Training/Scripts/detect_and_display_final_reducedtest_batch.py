...
image_dir = r"P:\petes_code\github\LunarPi\Training\images\rock_dataset"  # Directory with input images
output_dir = r"P:\petes_code\github\LunarPi\Training\detected_output"  # Directory for output images
...
if __name__ == "__main__":
    ...
    for i in range(0, len(image_files), 10):
        batch = image_files[i:i + 10]  # Get next 10 images
