...
output_image_path = r"P:\petes_code\github\LunarPi\Training\detected_output_8class.jpg"

tile_size = (332, 332)
stride = 171  # Keep for now, test tighter
confidence_threshold = 0.6  # Lowered to catch more rocks
...
def process_image(image_path):
    ...
    for y in range(0, h - tile_h + 1, stride):
        for x in range(0, w - tile_w + 1, stride):
            ...
            if confidence > confidence_threshold and label == "rock_combined":
